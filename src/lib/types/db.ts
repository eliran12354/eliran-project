/**
 * Database row types shared across the frontend.
 *
 * These mirror the PostgreSQL tables served by the backend API. They were
 * consolidated from older frontend modules when the app switched to the backend API.
 */
